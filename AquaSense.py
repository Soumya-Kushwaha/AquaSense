...
px.box(
    df, x=df.Potability, y=df.Chloramines, color=df.Potability, width=600, height=400
)
...
px.box(
    df, x=df.Potability, y=df.Conductivity, color=df.Potability, width=600, height=400
)
...
px.box(
    df, x=df.Potability, y=df.Organic_carbon, color=df.Potability, width=600, height=400
)
